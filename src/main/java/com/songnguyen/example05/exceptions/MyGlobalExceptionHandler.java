...
import com.songnguyen.example05.payloads.APIResponse;
...
public class MyGlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>>myConstraintVoilationException(ConstraintViolationException e){
        Map<String, String> res= new HashMap<>();
    ...
    public ResponseEntity<APIResponse> myMissPathVariableException(MissingPathVariableException e ){
